...
struct RestaurantPhotosView: View {
    ...
    let photoUrlStrings = ["https://letsbuildthatapp-videos.s3.us-west-2.amazonaws.com/e2f3f5d4-5993-4536-9d8d-b505d7986a5c",
        ...
        //                        .background(Color.red)
                    ...
                    ForEach(photoUrlStrings, id: \.self) { urlString in
                        ...
                        VStack(alignment: .leading, spacing:8) {
                            ...
                            .font(.system(size: 22))
                            Text("descriptionegjerpgjeprojgpoerjgpoerjgpoerjgopejropgjeprogjeoprgjoperjgoperngopenrmgpoerngopenrgopenropgneropgne")
                                .font(.system(size: 14))
                                .padding(.horizontal, 8)
                            
                            Text("Posted on 26/12/20")
                                .font(.system(size: 14))
                                .padding(.horizontal, 8)
